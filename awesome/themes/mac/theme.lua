...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/mac"
...
theme.lefticon                                  = theme.dir .. "/icons/lefticon.png"
...
-- UwU
local lefticon = wibox.widget.imagebox(theme.lefticon)
...
local arrl_pre  = separators.arrow_right("alpha", "#ffffff00")
local arrl_post = separators.arrow_right("#ffffff00", "alpha")
